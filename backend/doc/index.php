...
<head>
        <meta charset="utf-8" />
        <title>Clinic Management System -A Super Responsive Information System</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img src="assets/images/favicon.png" alt="" height="40px"></span>
                                    </a>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p> <a href="his_doc_reset_pwd.php" class="text-white-50 ml-1" style="font-weight:bold;">Forgot your password?</a></p>
